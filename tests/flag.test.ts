...
describe('Flag', () => {
  describe('constructor and getters', () => {
    it('should create a flag', () => {
      const flag = new Flag('1', 'boolean', 'test-flag', 'Test Flag', { value: { value: { boolean: true } } });
  ...
  describe('isEnabled', () => {
    it('should return true for enabled boolean flag', () => {
      const flag = new Flag('1', 'boolean', 'test', 'Test', { value: { value: { boolean: true } } });
      expect(flag.isEnabled()).toBe(true);
    });

    it('should return false for disabled boolean flag', () => {
      const flag = new Flag('1', 'boolean', 'test', 'Test', { value: { value: { boolean: false } } });
      expect(flag.isEnabled()).toBe(false);
    });

    it('should return false for non-boolean flags', () => {
      const stringFlag = new Flag('1', 'string', 'test', 'Test', { value: { value: { string: 'value' } } });
      expect(stringFlag.isEnabled()).toBe(false);

      const numberFlag = new Flag('1', 'number', 'test', 'Test', { value: { value: { number: 42 } } });
  ...
  describe('asBool', () => {
    ...
    it('should convert non-boolean values', () => {
      const stringFlag = new Flag('1', 'string', 'test', 'Test', { value: { value: { string: 'test' } } });
      expect(stringFlag.asBool()).toBe(true);

      const numberFlag = new Flag('1', 'number', 'test', 'Test', { value: { value: { number: 0 } } });
  ...
  describe('asString', () => {
    it('should return string value', () => {
      const flag = new Flag('1', 'string', 'test', 'Test', { value: { value: { string: 'hello' } } });
      expect(flag.asString()).toBe('hello');
    });

    it('should convert non-string values', () => {
      const boolFlag = new Flag('1', 'boolean', 'test', 'Test', { value: { value: { boolean: true } } });
  ...
  describe('asNumber', () => {
    ...
    it('should convert string to number', () => {
      const stringFlag = new Flag('1', 'string', 'test', 'Test', { value: { value: { string: '3.14' } } });
      expect(stringFlag.asNumber()).toBe(3.14);
    });

    it('should return 0 for invalid numbers', () => {
      const stringFlag = new Flag('1', 'string', 'test', 'Test', { value: { value: { string: 'invalid' } } });
